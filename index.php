...
<head>
    ...
    <title><?php echo ucwords(str_replace('_','',$page)) ?> | Warm Delights Bakery</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark bg-gradient" id="topNavBar">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'home')? 'active' : '' ?>" aria-current="page" href="./"><i class="fa fa-tasks text-light"></i><span>Home</span></a>
                    </li>
                    <?php if($_SESSION['type'] == 1): ?>
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'products')? 'active' : '' ?>" href="./?page=products"><i class="fa fa-cubes text-light"></i><span>Products</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'stocks')? 'active' : '' ?>" href="./?page=stocks"><i class="fa fa-cart-plus text-light"></i><span>Stocks</span></a>
                    </li>
                    <?php endif; ?>
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'sales')? 'active' : '' ?>" href="./?page=sales"><i class="fa fa-credit-card text-light"></i><span>Transactions</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'sales_report')? 'active' : '' ?>" href="./?page=sales_report"><i class="fa fa-bell text-light"></i><span>Sales</span></a>
                    </li>
                    <?php if($_SESSION['type'] == 1): ?>
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'users')? 'active' : '' ?>" aria-current="page" href="./?page=users"><i class="fa fa-users fa-lg text-white"></i><span>Users</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="./?page=maintenance"><i class="fa fa-wrench text-light"></i><span>Maintenance</span></a>
                    </li>
                    <?php endif; ?>
