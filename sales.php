        ...
        <div class="w-100 h-100 d-flex flex-column">
            <div class="row">
                ...
                <div class="col-4 d-flex justify-content-end">
                    <button class="btn btn-sm btn-primary rounded-pill " id="transaction-save-btn" type="button">Save Transaction</button>
                </div>
                                ...
                                <div class="h-100 overflow-auto" style="height:60vh !important ">
                                    <table class="table table-hover table-striped bg-light" id="plist">
                                        ...
                                        while($row = $qry->fetch_assoc()):
                                            ...
                                            $qty = $qty > 0 ? $qty : 0;
                                        ?>
                                        <tr class="item <?php echo $qty < 40? "bg-danger bg-opacity-25":'' ?>" data-id="<?php echo $row['product_id'] ?>">
