<div class="content py-3">
    <div class="card rounded-0 shadow">
        <div class="card-body">
            <h3 class="text-secondary">Welcome to Warm Delights Bakery</h3>
            <hr>
            <div class="col-12">
                    ...
                    <div class="col">
                        <div class="card text-dark">
                            <div class="card-body">
                                <div class="w-100 d-flex align-items-center">
                                    <div class="col-auto pe-1">
                                        <span class="fas fa-shopping-bag fs-3 text-danger"></span>
                                    </div>
                                    <div class="col-auto flex-grow-1">
                ...
                <div class="row">
                    <div class="col-12">
                        <h3 class="text-warning">Stock Available</h3>
                        <hr>
                            ...
                            <tbody>
                                <?php
                                    ...
                                    while($row = $qry->fetch_assoc()):
                                        ...
                                        $qty = $qty > 0 ? $qty : 0;
                                ?>
                                    <tr class="<?php echo $qty < 40? "bg-danger bg-opacity-25":'' ?>">
...
<script>
    $(function(){
        $('.restock').click(function(){
            uni_modal('Add New Stock for <span class="text-warning">'+$(this).attr('data-name')+"</span>","manage_stock.php?pid="+$(this).attr('data-pid'))
        })
