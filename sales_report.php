    ...
    <div class="card-body">
        ...
        <div class="row align-items-end">
            ...
            <div class="form-group col-md-4 d-flex">
                <div class="col-auto">
                    <button class="btn btn-primary rounded-pill" id="filter" type="button"><i class="fa fa-filter"></i> Filter</button>
                    <!-- <button class="btn btn-success rounded-pill" id="print" type="button"><i class="fa fa-print"></i> Print</button> -->
                </div>
            </div>
        </div>
        <hr>
